...
namespace MBLDefine {
    ...
    internal sealed class Key : InputValue {
        ...
        public static readonly Key Ride     = new Key("Ride",   new List<KeyCode> { KeyCode.Space , KeyCode.Joystick1Button5 });
        public static readonly Key Slow     = new Key("Slow",   new List<KeyCode> { KeyCode.LeftShift, KeyCode.Joystick1Button6 });
        public static readonly Key Shoot    = new Key("Shoot",  new List<KeyCode> { KeyCode.X, KeyCode.Joystick1Button1 });
